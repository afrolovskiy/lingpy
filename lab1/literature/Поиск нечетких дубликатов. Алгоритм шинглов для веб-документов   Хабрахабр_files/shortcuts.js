$(document).ready(function(){
	...
	$(document).bind('shortcuts.subscribe_comments', function(event, form){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'subscribe_comments' ]);
	...
	$(document).bind('shortcuts.add_to_tracker', function(event, form){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'add_to_tracker' ]);
	...
	$(document).bind('shortcuts.focus_to_search', function(event, form){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'focus_to_search' ]);
	...
	$(document).bind('shortcuts.submit_form', function(event, form){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'submit_form' ]);
	...
	$(document).bind('shortcuts.to_next_page', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'to_next_page' ]);
	...
	$(document).bind('shortcuts.to_prev_page', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'to_prev_page' ]);
	...
	$(document).bind('shortcuts.to_first_post', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'to_first_post' ]);
	...
	$(document).bind('shortcuts.to_last_post', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'to_last_post' ]);
		var shortcuts_items = $('.shortcuts_items')
		if(shortcuts_items.size()){
	...
	$(document).bind('shortcuts.to_next_post', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'to_next_post' ]);
		var shortcuts_items = $('.shortcuts_items')
		if(shortcuts_items.size()){
	...
	$(document).bind('shortcuts.to_prev_post', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'to_prev_post' ]);
		var shortcuts_items = $('.shortcuts_items')
		if(shortcuts_items.size()){
			if( $('.shortcuts_item.focus', shortcuts_items).size() == 0){
				$('.shortcuts_item', shortcuts_items).last().addClass('focus')
	...
	$(document).bind('shortcuts.open_post', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'open_post' ]);
		if( $('.shortcuts_items').size() ){
	...
	$(document).bind('shortcuts.to_comment_form', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'to_comment_form' ]);
	...
	$(document).bind('shortcuts.refresh_comments', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'refresh_comments' ]);
		if(g_show_xpanel){ 
	...
	$(document).bind('shortcuts.to_next_unreaded_comment', function(){
		if(typeof(_gaq) !== 'undefined') _gaq.push(['_trackEvent', 'Shortcuts', 'to_next_unreaded_comment' ]);
		if(g_show_xpanel){ 
